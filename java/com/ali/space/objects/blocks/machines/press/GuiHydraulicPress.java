...
public class GuiHydraulicPress extends GuiContainer{
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/gui/hydraulic_press.png");
	private final InventoryPlayer player;
	private final TileEntityHydraulicPress tileentity;
	
	public GuiHydraulicPress(InventoryPlayer player, TileEntityHydraulicPress tileentity) {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if(TileEntityHydraulicPress.isBurning(tileentity))
		{
