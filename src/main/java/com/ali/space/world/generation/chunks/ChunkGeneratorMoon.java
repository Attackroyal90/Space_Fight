...
//import com.jonispatented.moarmor.world.generation.generators.WorldGenStructure;
...
public class ChunkGeneratorMoon implements IChunkGenerator
{
    ...
    protected static final IBlockState YOUR_LIQUID = BlockInit.MOON_ROCK.getDefaultState();
    //Blocks that are usally gravel and soul sand
    protected static final IBlockState OTHER_BLOCK1 = BlockInit.MOON_ROCK.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = BlockInit.MOON_ROCK.getDefaultState();
    ...
    */
    ...
    public ChunkGeneratorMoon(World world, boolean generate, long seed)
    {
        this.world = world;
        this.generateStructures = generate;
        this.rand = new Random(seed);
        world.setSeaLevel(26);
